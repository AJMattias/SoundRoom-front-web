                                      ...
                                      >
                                        ...
                                        <div>
                                            <img 
                                                ...
                                                style={{width: '50px', height: '50px', objectFit: 'cover'}} // Estilo
                                                /> 
                                        </div>
                                        <div className="d-flex flex-column justify-content-center ms-2">
                                            <span className="fw-bold">{artista.name} {artista.lasName}</span>
                                            <span className="text-muted"> <FaMusic  size={20} />  Artista</span>
                                        </div>
                                    </div>
...
export default VerReservaPageSdE