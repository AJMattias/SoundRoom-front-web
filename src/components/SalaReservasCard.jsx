...
const SalaReservasCard = ({ reservasSelected, cancelarReserva }) => {
                ...
                <div key={reserva.id || index} // Usamos 'reserva.id' como key si existe
                    ...
                    <div 
                        ...
                        <div className="d-flex justify-content-between align-items-center w-100"> 
                            <div className="w-75">
                                <h4 className="fs-5">{reserva.idRoom.nameSalaEnsayo}</h4>
                                <div>
                                    {/* Usamos 'dateDisplay' que es la propiedad formateada por el componente padre */}
                                    {/* make p black and strong */}
                                    <p className="fw-bold mb-0">Artista: {reserva.idUser.name} {reserva.idUser.lastName}</p>
                                    <p className="mb-0">Fecha y hs: {reserva.dateDisplay}: {reserva.hsStart}hs - {reserva.hsEnd}hs </p>
                                    <p className="mb-0">Monto: ${reserva.totalPrice}</p>
                                </div>
                            </div>
...
export default SalaReservasCard
